...
export default function FreeStateBranchesBotCommand(bot: TelegrafPKG.Telegraf<TelegrafPKG.Context<Update>>) {
  bot.hears("Free State", async (ctx: MyContext) => {
    try {
      const provincialCode = 2;
