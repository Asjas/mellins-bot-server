...
export default function EasternCapeBranchesBotCommand(bot: TelegrafPKG.Telegraf<TelegrafPKG.Context<Update>>) {
  bot.hears("Eastern Cape", async (ctx: MyContext) => {
    const provincialCode = 1;
